<template>
  <div class="tw-h-screen tw-w-full tw-flex tw-flex-col tw-bg-white tw-px-4">
    <Navbar title="Cadastrar Despesa" route="/dashboard"></Navbar>
    <div class="tw-mt-20">
      <v-form>
        <v-row dense>
          <v-col cols="12">
        ...
        <v-btn class="mt-5" elevation="5" block :loading="loading" color="#425c59" @click.prevent.stop="createExpense"
               rounded>
